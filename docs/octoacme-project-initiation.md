...
- Stakeholder list & communication plan (coordinated by Stakeholder Representative when available)
- High-level timeline and key milestones
- Initial risk list (facilitated by Risk Coordinator when available)
